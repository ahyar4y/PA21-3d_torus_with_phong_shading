Public Class Form1
    ...
    Private Sub Form1_Shown(sender As Object, e As EventArgs) Handles MyBase.Shown
        ...
        torus = New Torus3D(0.0, 0.0, 0.0, 100, 50, 30, 30)
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        For i = 0 To torus.m
            ...
            For j = 0 To torus.n
                ...
                mesh.n(i, j) = GetVertexNormal(torus.center, torus.majorR, torus.minorR, c_phi, s_phi, Math.Sin(rY * Math.PI / 180), mesh.v(i, j))
            Next
        Next
        torus.mesh.n = mesh.v
        _vNormal.v = mesh.n
